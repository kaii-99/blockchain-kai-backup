...
import (
	...
	"github.com/kaii-99/blockchain-kai/app"
)
...
// genesisCommand builds genesis-related `blockchain-kaid genesis` command. Users may provide application specific commands as a parameter
